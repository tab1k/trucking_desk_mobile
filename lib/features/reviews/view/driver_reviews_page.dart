...
import 'package:fura24.kz/features/reviews/providers/driver_reviews_provider.dart';
      ...
      body: SafeArea(
        ...
        child: reviewsAsync.when(
          data: (reviews) => _ReviewsList(
            reviews: reviews,
            onRefresh: () =>
                ref.refresh(driverReviewsProvider(driverId).future),
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () =>
                        ref.refresh(driverReviewsProvider(driverId)),
